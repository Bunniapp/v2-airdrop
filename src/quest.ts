import { Deploy, Deposit, Swap, Transaction, Withdraw } from "./class.js";


export function getCompletedQuests(_transactions: Transaction[]): bigint {
  let completedQuests: bigint = 0n;

  if (isQuestCompleted_1(_transactions)) completedQuests++;
  if (isQuestCompleted_2(_transactions)) completedQuests++;
  if (isQuestCompleted_3(_transactions)) completedQuests++;
  if (isQuestCompleted_4(_transactions)) completedQuests++;
  if (isQuestCompleted_5(_transactions)) completedQuests++;
  if (isQuestCompleted_6(_transactions)) completedQuests++;
  if (isQuestCompleted_7(_transactions)) completedQuests++;
  if (isQuestCompleted_8(_transactions)) completedQuests++;
  if (isQuestCompleted_9(_transactions)) completedQuests++;
  if (isQuestCompleted_10(_transactions)) completedQuests++;
  if (isQuestCompleted_11(_transactions)) completedQuests++;

  return completedQuests;
}

function isQuestCompleted_1(_transactions: Transaction[]): boolean {
  const startTime: number = 1721606400;
  const endTime: number = 1722815999;
  ...
  let objectiveCompleted_1: boolean = false;
  let objectiveCompleted_2: boolean = false;
  let objectiveCompleted_3: boolean = false;
...
function isQuestCompleted_2(_transactions: Transaction[]): boolean {
  const startTime: number = 1721606400;
  const endTime: number = 1722815999;
  ...
  if (swaps && swaps.length) {
    const validSwaps = swaps.filter((swap) => {
      return (
        swap.currency0.toLowerCase() === "0x1a2d66D21C5D2D1E80D2Ebbe73BDC1F5d8a6c52C".toLowerCase() &&
...
function isQuestCompleted_3(_transactions: Transaction[]): boolean {
  const startTime: number = 1721865600;
  const endTime: number = 1723075199;
...
function isQuestCompleted_4(_transactions: Transaction[]): boolean {
  const startTime: number = 1722524400;
  const endTime: number = 1723733999;
...
function isQuestCompleted_5(_transactions: Transaction[]): boolean {
  const startTime: number = 1723042800;
  const endTime: number = 1724252399;
...
function isQuestCompleted_6(_transactions: Transaction[]): boolean {
  const startTime: number = 1723741200;
  const endTime: number = 1725037199;
...
function isQuestCompleted_7(_transactions: Transaction[]): boolean {
  const startTime: number = 1724864400;
  const endTime: number = 1726074000;
...
function isQuestCompleted_8(_transactions: Transaction[]): boolean {
  const startTime: number = 1725379200;
  const endTime: number = 1726588800;
...
function isQuestCompleted_9(_transactions: Transaction[]): boolean {
  const startTime: number = 1726153200;
  const endTime: number = 1727362800;
...
function isQuestCompleted_10(_transactions: Transaction[]): boolean {
  const startTime: number = 1726851600;
  const endTime: number = 1728061200;
  ...
  if (swaps && swaps.length) {
    const validSwaps = swaps.filter((swap) => {
      return (
        (
          swap.currency0.toLowerCase() === "0x61dC265c543c5d280A5270f4b10DA8f9FA3ac66E".toLowerCase()
        ) ||
        (
...
function isQuestCompleted_11(_transactions: Transaction[]): boolean {
  const startTime: number = 1727719200;
  const endTime: number = 1728928800;
  ...
  if (swaps && swaps.length) {
    const validSwaps = swaps.filter((swap) => {
      return (
        (
          swap.currency0.toLowerCase() === "0x83985Dc2c6f241b0301E5c88aD81677931c88760".toLowerCase() ||
          swap.currency0.toLowerCase() === "0x1ef5F52BdBe11Af2377C58ecC914A8c72Ea807cF".toLowerCase()
        ) &&
        (
